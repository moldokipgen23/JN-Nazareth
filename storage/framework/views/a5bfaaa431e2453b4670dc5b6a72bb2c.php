...
<?php if(isset($galleryFolders) && $galleryFolders->count() && \App\Helpers\Settings::get('sec_show_gallery', '1')): ?>
<?php $secTitleGallery = \App\Helpers\Settings::get('sec_title_gallery', 'Church Gallery'); ?>
<section style="padding:72px 0; background:#fff;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div style="display:flex; align-items:flex-end; justify-content:space-between; margin-bottom:32px; flex-wrap:wrap; gap:10px;">
            <div>
                <span style="font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:.1em; color:var(--primary); display:block; margin-bottom:6px;"><?php echo e(\App\Helpers\Settings::get('sec_label_gallery', 'Our Moments')); ?></span>
                <h2 style="font-size:26px; font-weight:800; color:#1c1917; margin:0; line-height:1.2;"><?php echo e($secTitleGallery); ?></h2>
                <?php $secSubGallery = \App\Helpers\Settings::get('sec_sub_gallery', ''); ?>
                <?php if($secSubGallery): ?><p style="font-size:13px; color:#78716c; margin:6px 0 0;"><?php echo e($secSubGallery); ?></p><?php endif; ?>
            </div>
            <a href="<?php echo e(route('gallery')); ?>" style="font-size:13px; font-weight:600; color:var(--primary); text-decoration:none; display:inline-flex; align-items:center; gap:5px; border:1px solid #bbf7d0; padding:7px 16px; border-radius:50px; background:#f0fdf4;" onmouseover="this.style.background='#dcfce7'" onmouseout="this.style.background='#f0fdf4'">
                View All Albums
        ...
        <div style="position:relative;">
            <div id="gal-carousel" style="display:flex; gap:20px; overflow-x:auto; scroll-snap-type:x mandatory; padding-bottom:12px; scrollbar-width:none; -ms-overflow-style:none;">
                <?php $__currentLoopData = $galleryFolders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <a href="<?php echo e(route('gallery.folder', $folder)); ?>" style="flex:0 0 210px; scroll-snap-align:start; text-decoration:none; display:block; perspective:900px;">
                    <div style="transition:transform .4s cubic-bezier(.25,.8,.25,1), box-shadow .4s; transform-style:preserve-3d; border-radius:16px; overflow:hidden; background:#fff; box-shadow:0 4px 20px rgba(0,0,0,.1);"
                        ...
                        <div style="position:relative; padding-top:72%; background:#e8f0ee; overflow:hidden;">
                            <?php if($gImg2): ?>
                            <div style="position:absolute; border-radius:10px; overflow:hidden; inset:6% 0 0 8%; opacity:.3; transform:rotate(3deg); z-index:1;"><img src="<?php echo e($gImg2); ?>" alt="" loading="lazy" style="width:100%;height:100%;object-fit:cover;"></div>
                            <?php endif; ?>
                            <?php if($gImg1): ?>
                            <div style="position:absolute; border-radius:10px; overflow:hidden; inset:3% 0 0 4%; opacity:.6; transform:rotate(1.2deg); z-index:2;"><img src="<?php echo e($gImg1); ?>" alt="" loading="lazy" style="width:100%;height:100%;object-fit:cover;"></div>
                            <?php endif; ?>
                            <div style="position:absolute; inset:0; z-index:3; overflow:hidden; border-radius:10px;">
                                <?php if($gCover): ?>
                                    <img src="<?php echo e($gCover); ?>" alt="<?php echo e($folder->name); ?>" loading="lazy" style="width:100%;height:100%;object-fit:cover;">
                                <?php else: ?>
                            ...
                            <div style="position:absolute; bottom:10px; left:12px; right:12px; z-index:5; color:#fff;">
                                <div style="font-size:13px; font-weight:800; text-shadow:0 1px 6px rgba(0,0,0,.5); line-height:1.3; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;"><?php echo e($folder->name); ?></div>
                            </div>
...
<?php /**PATH /Users/moldokipgen/Projects/EHLOM DIGITAL/Ehlom CMS/resources/views/public/partials/home/gallery.blade.php ENDPATH**/ ?>