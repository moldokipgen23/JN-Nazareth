...
<?php $__currentLoopData = $savedOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if ($__env->exists('public.partials.home.' . $_sec)) echo $__env->make('public.partials.home.' . $_sec, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/moldokipgen/Projects/EHLOM DIGITAL/Ehlom CMS/resources/views/public/home.blade.php ENDPATH**/ ?>