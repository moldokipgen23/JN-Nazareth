...
<?php if(isset($videos) && $videos->count() && \App\Helpers\Settings::get('sec_show_videos', '1')): ?>
<?php
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div style="display:flex; align-items:flex-end; justify-content:space-between; margin-bottom:36px; flex-wrap:wrap; gap:12px;">
            <div>
                ...
                <h2 style="font-size:30px; font-weight:800; color:#ffffff; margin:0; line-height:1.2;"><?php echo e($secTitleVideos); ?></h2>
                <p style="font-size:14px; color:#94a3b8; margin:6px 0 0;"><?php echo e(\App\Helpers\Settings::get('sec_sub_videos', 'Messages, choir worship, and church events')); ?></p>
            </div>
        ...
        <div style="position:relative;">
            ...
            <div style="overflow:hidden; border-radius:16px;">
                <div id="vid-track" style="display:flex; gap:16px; transition:transform .4s cubic-bezier(.4,0,.2,1); will-change:transform;">
                    <?php $__currentLoopData = $videoList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="vid-card" style="flex:0 0 calc(33.333% - 11px); min-width:0;"
                         data-embed="<?php echo e($video->embed_url); ?>"
                         data-title="<?php echo e(e($video->title)); ?>"
                         data-desc="<?php echo e(e($video->description ?? '')); ?>"
                         data-cat="<?php echo e($video->category); ?>">
                        <div onclick="openVideoModal(this.closest('.vid-card'))"
                            ...
                            <div style="position:relative; padding-top:56.25%; background:#0f172a; overflow:hidden;">
                                ...
                                <?php $catBg = match($video->category) { 'sermon'=>'rgba(59,130,246,.9)','choir'=>'rgba(168,85,247,.9)','event'=>'rgba(249,115,22,.9)',default=>'rgba(100,116,139,.9)' }; ?>
                                <div style="position:absolute; top:10px; left:10px; background:<?php echo e($catBg); ?>; color:#fff; font-size:9px; font-weight:800; padding:3px 8px; border-radius:20px; text-transform:uppercase; letter-spacing:.06em; backdrop-filter:blur(4px);"><?php echo e($video->category); ?></div>
                            ...
                            <div style="padding:14px 16px 16px;">
                                <h3 style="font-size:14px; font-weight:700; color:#f1f5f9; margin:0 0 6px; line-height:1.4; overflow:hidden; display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical;"><?php echo e($video->title); ?></h3>
                                <?php if($video->description): ?>
                                    <p style="font-size:12px; color:#64748b; margin:0; overflow:hidden; display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; line-height:1.5;"><?php echo e($video->description); ?></p>
                                <?php endif; ?>
        ...
        <div id="vid-dots" style="display:flex; justify-content:center; gap:7px; margin-top:24px;">
            <?php for($d = 0; $d < $totalVideos; $d++): ?>
            <button onclick="vidGoTo(<?php echo e($d); ?>)"
                    style="width:8px; height:8px; border-radius:50%; border:none; cursor:pointer; padding:0; transition:.2s; background:<?php echo e($d === 0 ? '#14b8a6' : 'rgba(255,255,255,.25)'); ?>; transform:<?php echo e($d === 0 ? 'scale(1.3)' : 'scale(1)'); ?>;"
                    data-dot="<?php echo e($d); ?>"></button>
            <?php endfor; ?>
        </div>
        <?php endif; ?>
...
<?php /**PATH /Users/moldokipgen/Projects/EHLOM DIGITAL/Ehlom CMS/resources/views/public/partials/home/videos.blade.php ENDPATH**/ ?>