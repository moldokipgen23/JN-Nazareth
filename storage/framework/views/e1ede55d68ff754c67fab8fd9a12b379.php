...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px;">
    <div>
        <h2 style="font-size:20px; font-weight:700; color:#0f172a; margin:0;">
            Good <?php echo e(now()->hour < 12 ? 'Morning' : (now()->hour < 17 ? 'Afternoon' : 'Evening')); ?>, <?php echo e(explode(' ', Auth::user()->name)[0]); ?> 👋
        </h2>
        <p style="font-size:13px; color:#64748b; margin:4px 0 0;">Here's what's happening at <?php echo e(\App\Helpers\Settings::get('site_name', 'your site')); ?> today.</p>
    </div>
...
<div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(200px, 1fr)); gap:16px; margin-bottom:24px;">
    ...
    <div class="stat-card">
        ...
        <div>
            <div style="font-size:26px; font-weight:800; color:#0f172a; line-height:1.1;"><?php echo e(number_format($stats['members'])); ?></div>
    ...
    <div class="stat-card">
        ...
        <div>
            <div style="font-size:26px; font-weight:800; color:#0f172a; line-height:1.1;"><?php echo e(number_format($stats['events'])); ?></div>
            <div style="font-size:12px; color:#64748b; font-weight:500; margin-top:2px;">Total Events</div>
            <div style="font-size:11px; color:#d97706; font-weight:600; margin-top:3px;"><?php echo e($stats['upcoming']); ?> upcoming</div>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div>
            <div style="font-size:26px; font-weight:800; color:#0f172a; line-height:1.1;"><?php echo e(number_format($stats['blogs'])); ?></div>
            <div style="font-size:12px; color:#64748b; font-weight:500; margin-top:2px;">Blog Posts</div>
            <div style="font-size:11px; color:#16a34a; font-weight:600; margin-top:3px;"><?php echo e($stats['published']); ?> published</div>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div>
            <div style="font-size:26px; font-weight:800; color:#0f172a; line-height:1.1;"><?php echo e(number_format($stats['documents'])); ?></div>
            <div style="font-size:12px; color:#64748b; font-weight:500; margin-top:2px;">Files Stored</div>
            <div style="font-size:11px; color:#9333ea; font-weight:600; margin-top:3px;"><?php echo e($stats['folders']); ?> folders</div>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div>
            <div style="font-size:26px; font-weight:800; color:#0f172a; line-height:1.1;"><?php echo e(number_format($stats['gallery'])); ?></div>
    ...
    <div class="stat-card">
        ...
        <div>
            <div style="font-size:26px; font-weight:800; color:#0f172a; line-height:1.1;"><?php echo e(number_format($stats['users'])); ?></div>
...
<div style="display:grid; grid-template-columns:1fr 360px; gap:20px; margin-bottom:24px;">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <span style="font-size:12px; color:#94a3b8;"><?php echo e(now()->subMonths(5)->format('M Y')); ?> — <?php echo e(now()->format('M Y')); ?></span>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('admin.events.index')); ?>" style="font-size:12px; color:#0d9488; text-decoration:none; font-weight:600;">View all</a>
        </div>
        ...
        <div style="display:flex; gap:14px; padding:14px 20px; border-bottom:1px solid #f8fafc; align-items:flex-start;">
            <div style="background:#f0fdfa; border-radius:10px; padding:8px 10px; text-align:center; flex-shrink:0; min-width:44px;">
                <div style="font-size:18px; font-weight:800; color:#0f766e; line-height:1;"><?php echo e($event->starts_at->format('d')); ?></div>
                <div style="font-size:10px; color:#0d9488; font-weight:700; text-transform:uppercase;"><?php echo e($event->starts_at->format('M')); ?></div>
            </div>
            <div>
                <div style="font-size:13px; font-weight:600; color:#0f172a;"><?php echo e($event->title); ?></div>
                ...
                <?php endif; ?>
                <div style="font-size:11px; color:#94a3b8; margin-top:2px;"><?php echo e($event->starts_at->format('g:i A')); ?></div>
            </div>
        </div>
...
<div style="display:grid; grid-template-columns:1fr 1fr; gap:20px;">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('admin.members.index')); ?>" style="font-size:12px; color:#0d9488; text-decoration:none; font-weight:600;">View all</a>
        </div>
        ...
        <?php $colors = ['#3b82f6','#8b5cf6','#14b8a6','#f59e0b','#ef4444']; $c = $colors[$loop->index % count($colors)]; ?>
        <div class="table-row" style="grid-template-columns:auto 1fr auto;">
            <div class="avatar" style="background:<?php echo e($c); ?>; margin-right:6px;">
                <?php echo e(strtoupper(substr($member->name, 0, 1))); ?>

            </div>
            <div>
                <div style="font-weight:600; color:#0f172a;"><?php echo e($member->name); ?></div>
                <div style="font-size:11px; color:#94a3b8;"><?php echo e($member->role ?? 'Member'); ?> <?php echo e($member->email ? '· '.$member->email : ''); ?></div>
            </div>
            <div style="font-size:11px; color:#94a3b8;"><?php echo e($member->created_at->diffForHumans()); ?></div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div style="padding:30px 20px; text-align:center; color:#94a3b8; font-size:13px;">No members yet.
            <a href="<?php echo e(route('admin.members.create')); ?>" style="color:#0d9488; font-weight:600;">Add first member →</a>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('admin.activity-logs.index')); ?>" style="font-size:12px; color:#0d9488; text-decoration:none; font-weight:600;">View all</a>
        </div>
        ...
        <div class="table-row" style="grid-template-columns:auto 1fr auto;">
            ...
            <div>
                <div style="font-size:12.5px; font-weight:600; color:#334155;">
                    <span class="action-badge" style="background:<?php echo e($bg); ?>; color:<?php echo e($fg); ?>; margin-right:5px;"><?php echo e(str_replace('_',' ', $log->action)); ?></span>
                </div>
                <div style="font-size:11px; color:#94a3b8;"><?php echo e($log->user?->name ?? 'System'); ?> · <?php echo e($log->ip_address); ?></div>
            </div>
            <div style="font-size:11px; color:#94a3b8; white-space:nowrap;"><?php echo e($log->created_at->diffForHumans(null, true)); ?></div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<script>
const labels  = <?php echo json_encode(array_keys($months->toArray()), 15, 512) ?>;
const data    = <?php echo json_encode(array_values($months->toArray()), 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/moldokipgen/Projects/EHLOM DIGITAL/Ehlom CMS/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>