...
<head>
    ...
    <?php if($ogImage): ?><meta property="og:image" content="<?php echo e(\App\Helpers\Settings::storageUrl($ogImage)); ?>"><?php endif; ?>
    ...
    <?php if($ogImage): ?><meta name="twitter:image" content="<?php echo e(\App\Helpers\Settings::storageUrl($ogImage)); ?>"><?php endif; ?>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Organization",
      "name": "<?php echo e($schemaName); ?>",
      "url": "<?php echo e(url('/')); ?>",
      "description": "<?php echo e($seoDesc); ?>",
      <?php if(\App\Helpers\Settings::get('contact_address')): ?>"address": {
        "@type": "PostalAddress",
        "streetAddress": "<?php echo e(addslashes(\App\Helpers\Settings::get('contact_address', ''))); ?>"
      }<?php endif; ?>
    }
    </script>

    <!-- Favicon -->
    <link rel="icon" href="<?php echo e($favicon ? \App\Helpers\Settings::storageUrl($favicon) : '/favicon.ico'); ?>">
    ...
    <header class="sticky top-0 z-50" style="background: rgba(253,248,240,0.97); backdrop-filter: blur(8px); border-bottom: 1px solid #e7dfd4; box-shadow: 0 1px 12px rgba(0,0,0,0.06);">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 shrink-0">
                    <?php if($logo): ?>
                        <img src="<?php echo e(\App\Helpers\Settings::storageUrl($logo)); ?>"
                    ...
                    <?php else: ?>
                        <span class="inline-flex items-center gap-2 font-bold tracking-tight brand-text" style="font-family:'Playfair Display',Georgia,serif;">
                            ...
                            <span style="font-size:1.1rem; font-weight:800; line-height:1.2;"><?php echo e($siteName); ?></span>
                        </span>
                    <?php endif; ?>
                </a>
                ...
                <nav class="hidden md:flex items-center gap-7 text-sm font-medium">
                    <a href="<?php echo e(route('home')); ?>"
                       class="<?php echo e(request()->routeIs('home') ? 'nav-active' : 'nav-link'); ?> transition">Home</a>
                    <a href="<?php echo e(route('about')); ?>"
                       class="<?php echo e(request()->routeIs('about') ? 'nav-active' : 'nav-link'); ?> transition">Our Story</a>
                    <a href="<?php echo e(route('blogs')); ?>"
                       class="<?php echo e(request()->routeIs('blogs*') ? 'nav-active' : 'nav-link'); ?> transition">Blog</a>
                    <a href="<?php echo e(route('events')); ?>"
                       class="<?php echo e(request()->routeIs('events*') ? 'nav-active' : 'nav-link'); ?> transition">Events</a>
                    <a href="<?php echo e(route('gallery')); ?>"
                       class="<?php echo e(request()->routeIs('gallery*') ? 'nav-active' : 'nav-link'); ?> transition">Gallery</a>
                    <a href="<?php echo e(route('videos')); ?>"
                       class="<?php echo e(request()->routeIs('videos*') ? 'nav-active' : 'nav-link'); ?> transition">Videos</a>
                    <?php $__currentLoopData = $navPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navPage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('page', $navPage->slug)); ?>"
                           class="<?php echo e(request()->is('page/' . $navPage->slug) ? 'nav-active' : 'nav-link'); ?> transition"><?php echo e($navPage->title); ?></a>
        ...
        <div id="mobile-menu" class="hidden md:hidden border-t border-gray-100 bg-white shadow-md">
            <div class="px-4 py-3 space-y-1 text-sm font-medium">
                <a href="<?php echo e(route('home')); ?>"
                   class="block py-2.5 px-3 rounded-lg <?php echo e(request()->routeIs('home') ? 'brand-text font-semibold bg-gray-50' : 'text-gray-700 hover:bg-gray-50'); ?> transition">Home</a>
                <a href="<?php echo e(route('about')); ?>"
                   class="block py-2.5 px-3 rounded-lg <?php echo e(request()->routeIs('about') ? 'brand-text font-semibold bg-gray-50' : 'text-gray-700 hover:bg-gray-50'); ?> transition">Our Story</a>
                <a href="<?php echo e(route('blogs')); ?>"
                   class="block py-2.5 px-3 rounded-lg <?php echo e(request()->routeIs('blogs*') ? 'brand-text font-semibold bg-gray-50' : 'text-gray-700 hover:bg-gray-50'); ?> transition">Blog</a>
                <a href="<?php echo e(route('events')); ?>"
                   class="block py-2.5 px-3 rounded-lg <?php echo e(request()->routeIs('events*') ? 'brand-text font-semibold bg-gray-50' : 'text-gray-700 hover:bg-gray-50'); ?> transition">Events</a>
                <a href="<?php echo e(route('gallery')); ?>"
                   class="block py-2.5 px-3 rounded-lg <?php echo e(request()->routeIs('gallery*') ? 'brand-text font-semibold bg-gray-50' : 'text-gray-700 hover:bg-gray-50'); ?> transition">Gallery</a>
                <a href="<?php echo e(route('videos')); ?>"
                   class="block py-2.5 px-3 rounded-lg <?php echo e(request()->routeIs('videos*') ? 'brand-text font-semibold bg-gray-50' : 'text-gray-700 hover:bg-gray-50'); ?> transition">Videos</a>
                <?php $__currentLoopData = $navPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navPage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('page', $navPage->slug)); ?>"
                       class="block py-2.5 px-3 rounded-lg <?php echo e(request()->is('page/' . $navPage->slug) ? 'brand-text font-semibold bg-gray-50' : 'text-gray-700 hover:bg-gray-50'); ?> transition"><?php echo e($navPage->title); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <div class="lg:col-span-2">
                    <div class="flex items-center gap-2 mb-4">
                        <?php if($logo): ?>
                            <img src="<?php echo e(\App\Helpers\Settings::storageUrl($logo)); ?>"
                                 alt="<?php echo e($footerName); ?>" class="h-8 w-auto object-contain brightness-200">
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                        <span class="text-white font-bold text-lg"><?php echo e($footerName); ?></span>
                    </div>
                    <p class="text-sm leading-relaxed text-gray-400 max-w-xs"><?php echo e($footerTagline); ?></p>
                    ...
                    <?php if($hasSocial): ?>
                        <div class="flex items-center gap-3 mt-6">
                            ...
                            <?php endif; ?>
                            <?php if($twitter): ?>
                                <a href="<?php echo e($twitter); ?>" target="_blank" rel="noopener" aria-label="Twitter / X"
                            ...
                            <?php endif; ?>
                            <?php if($whatsapp): ?>
                                <a href="https://wa.me/<?php echo e(preg_replace('/\D/', '', $whatsapp)); ?>" target="_blank" rel="noopener" aria-label="WhatsApp"
                ...
                <!-- Quick Links -->
                <div>
                    <h3 class="text-white font-semibold text-xs uppercase tracking-widest mb-4"><?php echo e($footerLinksTitle); ?></h3>
                    <ul class="space-y-2.5 text-sm">
                        <li><a href="<?php echo e(route('home')); ?>"    class="hover:text-white transition">Home</a></li>
                        <li><a href="<?php echo e(route('about')); ?>"   class="hover:text-white transition">Our Story</a></li>
                        <li><a href="<?php echo e(route('blogs')); ?>"   class="hover:text-white transition">Blog</a></li>
                        <li><a href="<?php echo e(route('events')); ?>"  class="hover:text-white transition">Events</a></li>
                        <li><a href="<?php echo e(route('gallery')); ?>" class="hover:text-white transition">Gallery</a></li>
                        <li><a href="<?php echo e(route('videos')); ?>"  class="hover:text-white transition">Videos</a></li>
                    </ul>
                </div>

                <!-- Contact -->
                <div>
                    <h3 class="text-white font-semibold text-xs uppercase tracking-widest mb-4"><?php echo e($footerContactTitle); ?></h3>
                    <ul class="space-y-3 text-sm text-gray-400">
                        <?php if($contactAddr): ?>
                            <li class="flex items-start gap-2">
                                ...
                                <span><?php echo e($contactAddr); ?></span>
                            </li>
                        <?php endif; ?>
                        <?php if($contactPhone): ?>
                            <li class="flex items-center gap-2">
                                ...
                                <a href="tel:<?php echo e($contactPhone); ?>" class="hover:text-white transition"><?php echo e($contactPhone); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if($contactEmail): ?>
                            <li class="flex items-center gap-2">
                                ...
                                <a href="mailto:<?php echo e($contactEmail); ?>" class="hover:text-white transition"><?php echo e($contactEmail); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if(!$contactAddr && !$contactPhone && !$contactEmail): ?>
            ...
            <div style="border-top:1px solid rgba(255,255,255,0.08); margin-top:40px; padding-top:24px; display:flex; flex-direction:column; align-items:center; gap:12px; font-size:0.75rem; color:#6b7280; text-align:center;">
                ...
                <a href="https://ehlom.com" target="_blank" rel="noopener"
                   ...
                   onmouseout="this.style.background='rgba(255,255,255,.06)'; this.style.borderColor='rgba(255,255,255,.12)'; this.style.color='#9ca3af';">
                    <?php if(file_exists(public_path('images/ehlom-logo.png'))): ?>
                    ...
                    <?php endif; ?>
                    <span style="font-size:.72rem; line-height:1.3;"><?php echo e($footerCreditText); ?></span>
                </a>
                <?php endif; ?>
            </div>
        </div>
...
<?php /**PATH /Users/moldokipgen/Projects/EHLOM DIGITAL/Ehlom CMS/resources/views/layouts/public.blade.php ENDPATH**/ ?>