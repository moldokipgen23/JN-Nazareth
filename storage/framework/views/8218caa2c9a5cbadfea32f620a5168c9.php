<?php $__env->startSection('page-title', $type === 'programs' ? 'Programmes Folders' : 'Gallery Folders'); ?>
...
<div style="display:flex; gap:8px; margin-bottom:20px; background:#f8fafc; padding:4px; border-radius:10px; width:fit-content;">
    <a href="<?php echo e(route('admin.gallery-folders.index', ['type' => 'gallery'])); ?>"
       style="padding:7px 18px; border-radius:8px; font-size:12px; font-weight:600; text-decoration:none;
              <?php echo e($type === 'gallery' ? 'background:#0f766e; color:#fff; box-shadow:0 2px 8px rgba(15,118,110,.3);' : 'color:#64748b;'); ?>">
        Gallery
    </a>
    <a href="<?php echo e(route('admin.gallery-folders.index', ['type' => 'programs'])); ?>"
       style="padding:7px 18px; border-radius:8px; font-size:12px; font-weight:600; text-decoration:none;
              <?php echo e($type === 'programs' ? 'background:#0f766e; color:#fff; box-shadow:0 2px 8px rgba(15,118,110,.3);' : 'color:#64748b;'); ?>">
        Programmes
    </a>
</div>
...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:20px; flex-wrap:wrap; gap:10px;">
    <div>
        <h2 style="font-size:18px; font-weight:700; color:#0f172a; margin:0;">
            <?php echo e($type === 'programs' ? 'Programmes Gallery Folders' : 'Gallery Folders'); ?>

        </h2>
        <p style="font-size:12px; color:#64748b; margin:4px 0 0;">
            <?php echo e($type === 'programs' ? 'Organise Programmes/NGO photos into albums.' : 'Organise church photos into albums.'); ?>
    ...
    <div style="display:flex; gap:10px; align-items:center; flex-wrap:wrap;">
        ...
        <?php endif; ?>
        <a href="<?php echo e(route('admin.gallery-folders.create', ['type' => $type])); ?>"
           style="background:linear-gradient(135deg,#0f766e,#14b8a6); color:#fff; border:none; padding:8px 18px; border-radius:8px; font-size:12px; font-weight:600; text-decoration:none; display:inline-flex; align-items:center; gap:6px;">
            ...
            New <?php echo e($type === 'programs' ? 'Programmes' : 'Gallery'); ?> Folder
        </a>
    </div>
</div>
...
<div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(220px,1fr)); gap:16px;">
    ...
    <div style="background:#fff; border-radius:14px; border:1px solid #f1f5f9; box-shadow:0 2px 8px rgba(0,0,0,.06); overflow:hidden;">
        ...
        <a href="<?php echo e(route('admin.gallery-folders.show', $folder)); ?>"
           style="display:block; position:relative; padding-top:65%; background:#f8fafc; overflow:hidden;">
            <?php if($folder->cover_image): ?>
                <img src="<?php echo e(\App\Helpers\Settings::storageUrl($folder->cover_image)); ?>"
                     alt="<?php echo e($folder->name); ?>"
            ...
            <?php endif; ?>
            <div style="position:absolute; top:8px; left:8px; background:<?php echo e($folder->type === 'programs' ? '#7c3aed' : '#0f766e'); ?>; color:#fff; font-size:9px; font-weight:700; padding:2px 7px; border-radius:20px; letter-spacing:.05em;">
                <?php echo e(strtoupper($folder->type)); ?>
            ...
            <div style="position:absolute; bottom:8px; right:8px; background:rgba(0,0,0,.6); color:#fff; font-size:10px; font-weight:600; padding:3px 8px; border-radius:20px;">
                <?php echo e($folder->items_count); ?> photo<?php echo e($folder->items_count != 1 ? 's' : ''); ?>
        ...
        <div style="padding:12px 14px;">
            ...
            <div style="display:flex; gap:6px; margin-top:8px;">
                ...
                <a href="<?php echo e(route('admin.gallery-folders.edit', $folder)); ?>"
                ...
                <form method="POST" action="<?php echo e(route('admin.gallery-folders.destroy', $folder)); ?>"
                      onsubmit="return confirm('Delete folder and ALL <?php echo e($folder->items_count); ?> image(s)? This cannot be undone.')">
...
<div style="background:#fff; border-radius:14px; border:1px solid #f1f5f9; padding:60px 20px; text-align:center;">
    ...
    <p style="font-size:13px; color:#94a3b8; margin:0 0 16px;">Create your first <?php echo e($type === 'programs' ? 'Programmes' : 'gallery'); ?> album.</p>
    <a href="<?php echo e(route('admin.gallery-folders.create', ['type' => $type])); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/moldokipgen/Projects/EHLOM DIGITAL/Ehlom CMS/resources/views/admin/gallery-folders/index.blade.php ENDPATH**/ ?>