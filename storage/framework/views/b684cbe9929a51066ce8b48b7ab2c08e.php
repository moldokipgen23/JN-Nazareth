...
<section style="padding:80px 0; background:var(--cream); position:relative; overflow:hidden;">
    <div style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); font-family:'Playfair Display',serif; font-size:clamp(5rem,15vw,12rem); font-weight:900; color:rgba(45,106,79,0.04); white-space:nowrap; pointer-events:none; user-select:none; line-height:1;"><?php echo e(\App\Helpers\Settings::get('site_name','Community')); ?></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" style="position:relative; z-index:1;">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
                ...
                <div style="position:relative; width:100%; max-width:300px; margin-bottom:44px;">
                    ...
                    <div style="position:relative; z-index:1; border-radius:16px; overflow:hidden; box-shadow:0 12px 40px rgba(0,0,0,0.14); aspect-ratio:4/5; background:#e7dfd4;">
                        <?php if($leaderPhoto): ?>
                            <img src="<?php echo e(\App\Helpers\Settings::storageUrl($leaderPhoto)); ?>" alt="<?php echo e($leaderName); ?>" style="width:100%; height:100%; object-fit:cover; display:block;">
                        <?php else: ?>
                    ...
                    <div style="position:absolute; bottom:-18px; left:50%; transform:translateX(-50%); z-index:2; background:var(--primary); color:#fff; padding:9px 18px; border-radius:50px; white-space:nowrap; box-shadow:0 6px 20px rgba(45,106,79,0.3); text-align:center;">
                        <div style="font-family:'Playfair Display',serif; font-size:.88rem; font-weight:700; line-height:1.2;"><?php echo e($leaderName); ?></div>
                        <div style="font-size:0.62rem; opacity:0.8; text-transform:uppercase; letter-spacing:0.08em; margin-top:2px;"><?php echo e($leaderTitle); ?></div>
                    </div>
                </div>

                <p style="color:#57534e; font-size:1rem; line-height:1.85; margin-bottom:20px;"><?php echo e($leaderDesc); ?></p>

                <?php if(\App\Helpers\Settings::get('leader_governance_note')): ?>
                <div style="background:#fff; border-left:3px solid var(--primary); border-radius:0 12px 12px 0; padding:12px 16px;">
                    <p style="font-size:0.82rem; color:#78716c; line-height:1.7; margin:0;">
                        <?php echo nl2br(e(\App\Helpers\Settings::get('leader_governance_note'))); ?>
            ...
            <div>
                ...
                <?php $__currentLoopData = $paragraphs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $para): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(!empty($para)): ?>
                <p style="font-size:<?php echo e($i === 0 ? '1.02rem' : '.92rem'); ?>; color:#57534e; line-height:1.85; margin-bottom:14px; <?php echo e($i === 0 ? 'font-weight:500;' : ''); ?>">
                    <?php if($i === 0): ?>
                    <span style="font-family:'Playfair Display',serif; font-size:2.6rem; font-weight:800; color:var(--primary); float:left; line-height:0.82; margin-right:8px; margin-top:6px;"><?php echo e(mb_substr($para,0,1)); ?></span><?php echo e(mb_substr($para,1)); ?>
...
<?php endif; ?>
<?php /**PATH /Users/moldokipgen/Projects/EHLOM DIGITAL/Ehlom CMS/resources/views/public/partials/home/story.blade.php ENDPATH**/ ?>