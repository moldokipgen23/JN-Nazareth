...
?>
<?php if($logo): ?>
    <img src="<?php echo e(\App\Helpers\Settings::storageUrl($logo)); ?>" alt="<?php echo e($siteName); ?>" style="height:36px; width:auto; object-fit:contain;">
<?php else: ?>
    <div style="display:flex; align-items:center; gap:8px;">
        ...
        <span style="font-size:14px; font-weight:700; color:#0f172a; white-space:nowrap;"><?php echo e($siteName); ?></span>
    </div>
<?php endif; ?>
<?php /**PATH /Users/moldokipgen/Projects/EHLOM DIGITAL/Ehlom CMS/resources/views/components/application-logo.blade.php ENDPATH**/ ?>