...
<?php if(\App\Helpers\Settings::get('sec_show_map', '1')): ?>
<?php
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900"><?php echo e($secTitleMap); ?></h2>
            <?php if($mapSubtitle): ?>
            <p class="mt-3 text-gray-500 max-w-xl mx-auto text-base"><?php echo e($mapSubtitle); ?></p>
            <?php endif; ?>
        </div>
            ...
            <div>
                ...
                <div class="space-y-4 text-sm text-gray-600">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="tel:<?php echo e($contactPhone); ?>" class="hover:brand-text transition"><?php echo e($contactPhone); ?></a>
                    </div>
                    <?php endif; ?>
                    <?php if($contactEmail): ?>
                    <div class="flex items-center gap-3">
                        ...
                        <a href="mailto:<?php echo e($contactEmail); ?>" class="hover:brand-text transition"><?php echo e($contactEmail); ?></a>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH /Users/moldokipgen/Projects/EHLOM DIGITAL/Ehlom CMS/resources/views/public/partials/home/map.blade.php ENDPATH**/ ?>