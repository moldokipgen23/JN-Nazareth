...
<?php if(\App\Helpers\Settings::get('sec_show_cta', '1')): ?>
<?php
...
<section style="position:relative; overflow:hidden; background:var(--secondary);">
    <?php if(\App\Helpers\Settings::get('cta_bg_image')): ?><div style="position:absolute; inset:0; background-image:url('<?php echo e(asset('storage/'.\App\Helpers\Settings::get('cta_bg_image'))); ?>'); background-size:cover; background-position:center; opacity:0.18;"></div><?php endif; ?>
    ...
    <div style="position:relative; z-index:10; max-width:760px; margin:0 auto; padding:80px 24px; text-align:center;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:14px; justify-content:center;">
            <?php if($btn1Text && $btn1Link): ?>
            <a href="<?php echo e($btn1Link); ?>"
            ...
            <?php endif; ?>
            <?php if($btn2Text && $btn2Link): ?>
            <a href="<?php echo e($btn2Link); ?>"
...
<?php endif; ?>
<?php /**PATH /Users/moldokipgen/Projects/EHLOM DIGITAL/Ehlom CMS/resources/views/public/partials/home/cta.blade.php ENDPATH**/ ?>