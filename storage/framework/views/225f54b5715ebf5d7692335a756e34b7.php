...
<section id="hero-slider" aria-label="Hero Banner">
    ...
    <div class="hero-slide <?php echo e($i === 0 ? 'active' : ''); ?>" id="slide-<?php echo e($i); ?>">
        <img src="<?php echo e(\App\Helpers\Settings::storageUrl($slide->image)); ?>"
             alt="<?php echo e($slide->title ?? 'Banner'); ?>"
             <?php echo e($i === 0 ? '' : 'loading="lazy"'); ?>>
    ...
    <div style="position:absolute; inset:0; z-index:3; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; padding:40px 24px;">
        ...
        <div style="display:inline-flex; align-items:center; gap:7px; background:rgba(255,255,255,.1); backdrop-filter:blur(8px); border:1px solid rgba(255,255,255,.18); border-radius:50px; padding:7px 18px; margin-bottom:26px; font-size:.7rem; font-weight:700; text-transform:uppercase; letter-spacing:.14em; color:rgba(255,255,255,.85);">
            ...
            <?php echo e(\App\Helpers\Settings::get('site_tagline', 'Together as One')); ?>

        </div>

        
        <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="slide-content" id="slide-content-<?php echo e($i); ?>" style="<?php echo e($i !== 0 ? 'display:none;' : ''); ?>">
            <h1 class="<?php echo e($i === 0 ? 'hero-text-in' : ''); ?>"
                ...
                <?php echo e($slide->title ?: $heroTitle); ?>
    ...
    <div style="position:absolute; bottom:32px; left:50%; transform:translateX(-50%); z-index:4; display:flex; gap:8px; align-items:center;">
        <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button class="slider-dot <?php echo e($i === 0 ? 'active' : ''); ?>" id="dot-<?php echo e($i); ?>" onclick="goToSlide(<?php echo e($i); ?>)" aria-label="Slide <?php echo e($i + 1); ?>"></button>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<script>
(function(){
    const total = <?php echo e($slides->count()); ?>;
...
<section style="position:relative; width:100%; overflow:hidden; height:clamp(520px,85vh,860px); background:linear-gradient(160deg,#05190c 0%,#1b4332 100%);">
    ...
    <div style="position:relative; z-index:2; height:100%; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; padding:40px 24px;">
        ...
        <h1 class="hero-text-in" style="font-family:'Playfair Display',Georgia,serif; font-size:clamp(2.4rem,6vw,5rem); font-weight:800; line-height:1.1; color:#fff; text-shadow:0 4px 28px rgba(0,0,0,.55); max-width:800px; margin-bottom:18px;"><?php echo e($heroTitle); ?></h1>
        <p style="color:rgba(255,255,255,.82); font-size:clamp(.95rem,2vw,1.2rem); max-width:560px; line-height:1.75; margin-bottom:40px;"><?php echo e($heroSubtitle); ?></p>
        <div style="display:flex; flex-wrap:wrap; gap:14px; justify-content:center;">
            <a href="<?php echo e($heroLink); ?>" style="display:inline-flex; align-items:center; gap:9px; background:#fff; color:#0f766e; font-weight:700; font-size:.95rem; padding:13px 30px; border-radius:50px; text-decoration:none; box-shadow:0 6px 24px rgba(0,0,0,.3);"><?php echo e($heroCta); ?><svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7"/></svg></a>
...
<?php /**PATH /Users/moldokipgen/Projects/EHLOM DIGITAL/Ehlom CMS/resources/views/public/partials/home/hero.blade.php ENDPATH**/ ?>