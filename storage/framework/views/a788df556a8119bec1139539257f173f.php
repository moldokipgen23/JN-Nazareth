...
<head>
    ...
    <title><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?> — <?php echo e(\App\Helpers\Settings::get('site_name', 'Ehlom CMS')); ?> Admin</title>
    ...
    <aside id="sidebar" style="width:240px; background:linear-gradient(180deg,#0f172a 0%,#134e4a 100%); display:flex; flex-direction:column; flex-shrink:0; overflow-y:auto; transition:transform .25s ease; z-index:50;">
        ...
        <div style="padding:22px 20px 16px; border-bottom:1px solid rgba(255,255,255,.07);">
            <div style="display:flex; align-items:center; gap:12px;">
                ...
                <div>
                    <div style="color:#fff;font-weight:700;font-size:13px;line-height:1.3;"><?php echo e(\App\Helpers\Settings::get('site_name', 'Ehlom CMS')); ?></div>
        ...
        <div style="padding:14px 16px; border-bottom:1px solid rgba(255,255,255,.07);">
            <div style="display:flex;align-items:center;gap:10px;">
                ...
                <div>
                    <div style="color:#e2e8f0;font-size:12.5px;font-weight:600;"><?php echo e(Auth::user()->name); ?></div>
                    <div style="display:flex;align-items:center;gap:5px;">
                        <span style="width:7px;height:7px;background:#22c55e;border-radius:50%;display:inline-block;"></span>
                        <span style="color:#94a3b8;font-size:11px;text-transform:capitalize;"><?php echo e(Auth::user()->getRoleNames()->first() ?? 'user'); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <nav style="flex:1; padding:14px 12px; display:flex; flex-direction:column; gap:2px;">
            ...
            <a href="<?php echo e(route('admin.folders.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.folders.*') || request()->routeIs('admin.documents.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.hall-of-fame.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.hall-of-fame.*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg>
                Hall of Fame
            </a>
            <?php endif; ?>

            <a href="<?php echo e(route('admin.gallery-folders.index', ['type' => 'gallery'])); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.gallery-folders.*') && request()->get('type','gallery') === 'gallery' ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.gallery-folders.index', ['type' => 'programs'])); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.gallery-folders.*') && request()->get('type') === 'programs' ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 7a2 2 0 012-2h3l2 2h8a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V7z"/></svg>
                Programme Albums
            </a>

            <a href="<?php echo e(route('admin.videos.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.videos.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.customizer.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.customizer.*') ? 'active' : ''); ?>">
        ...
        <div style="padding:12px 16px; border-top:1px solid rgba(255,255,255,.07);">
            <a href="<?php echo e(route('home')); ?>" target="_blank" style="display:flex;align-items:center;gap:8px;color:#94a3b8;font-size:12px;text-decoration:none;padding:7px 10px;border-radius:7px;margin-bottom:4px;" onmouseover="this.style.background='rgba(255,255,255,.06)'" onmouseout="this.style.background='transparent'">
    ...
    <div style="flex:1; display:flex; flex-direction:column; overflow:hidden;">
        ...
        <header style="background:#fff; border-bottom:1px solid #e2e8f0; height:60px; display:flex; align-items:center; justify-content:space-between; padding:0 16px; flex-shrink:0; box-shadow:0 1px 4px rgba(0,0,0,.04);">
            <div style="display:flex;align-items:center;gap:12px;">
                ...
                <div>
                    <div style="font-size:15px;font-weight:700;color:#0f172a;"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></div>
                    <div style="font-size:10px;color:#94a3b8;" class="hidden sm:block"><?php echo e(\App\Helpers\Settings::get('site_name', 'Ehlom CMS')); ?> Management</div>
                </div>
            </div>
            <div style="display:flex;align-items:center;gap:10px;">
                <span style="font-size:11px;color:#64748b;" class="hidden sm:block"><?php echo e(now()->format('d M Y')); ?></span>
                <a href="<?php echo e(route('profile.edit')); ?>" style="display:flex;align-items:center;gap:8px;text-decoration:none;background:#f8fafc;border:1px solid #e2e8f0;padding:6px 10px;border-radius:8px;">
                    ...
                    <span style="font-size:12px;font-weight:600;color:#334155;" class="hidden sm:block"><?php echo e(Auth::user()->name); ?></span>
                </a>
            </div>
        </header>
...
<nav class="bottom-nav" style="position:fixed; bottom:0; left:0; right:0; background:#fff; border-top:1px solid #e2e8f0; z-index:30; box-shadow:0 -2px 12px rgba(0,0,0,.08);">
    <a href="<?php echo e(route('admin.dashboard')); ?>" class="bottom-nav-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
        Home
    </a>
    <a href="<?php echo e(route('admin.members.index')); ?>" class="bottom-nav-link <?php echo e(request()->routeIs('admin.members.*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.folders.index')); ?>" class="bottom-nav-link <?php echo e(request()->routeIs('admin.folders.*') || request()->routeIs('admin.documents.*') ? 'active' : ''); ?>">
        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 7a2 2 0 012-2h4l2 2h8a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V7z"/></svg>
        Docs
    </a>
    <a href="<?php echo e(route('admin.gallery.index')); ?>" class="bottom-nav-link <?php echo e(request()->routeIs('admin.gallery.*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.blogs.index')); ?>" class="bottom-nav-link <?php echo e(request()->routeIs('admin.blogs.*') ? 'active' : ''); ?>">
        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 20H5a2 2 0 01-2-2V7a2 2 0 012-2h10l4 4v11a2 2 0 01-2 2z"/></svg>
        Blog
    </a>
</nav>
...
<?php /**PATH /Users/moldokipgen/Projects/EHLOM DIGITAL/Ehlom CMS/resources/views/layouts/admin.blade.php ENDPATH**/ ?>