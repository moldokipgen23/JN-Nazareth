...
<div class="max-w-2xl">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Update information for {{ $student->name }}.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8">
        <form method="POST" action="{{ route('admin.students.update', $student) }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <a href="{{ route('admin.students.show', $student) }}" class="px-6 py-2 border border-gray-300 text-gray-600 text-sm font-medium rounded-lg hover:bg-gray-50 transition">
                    Cancel
                </a>
            </div>
        </form>
