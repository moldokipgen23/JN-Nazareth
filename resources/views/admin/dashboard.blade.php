...
<div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(200px, 1fr)); gap:16px; margin-bottom:24px;">
    ...
    <div class="stat-card">
        ...
        <div>
            <div style="font-size:26px; font-weight:800; color:#0f172a; line-height:1.1;">{{ $pendingQuestions + $pendingNotes + $pendingMarks + $pendingAttendance }}</div>
            <div style="font-size:12px; color:#64748b; font-weight:500; margin-top:2px;">Pending Reviews</div>
            <div style="font-size:11px; color:#d97706; font-weight:600; margin-top:3px;">
                {{ $pendingMarks }} marks · {{ $pendingAttendance }} attendance · {{ $pendingQuestions }} questions
            </div>
        </div>
    </div>
