...
<div class="max-w-xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-bold text-gray-900">Add Important Link</h2>
    </div>

    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8">
        <form method="POST" action="{{ route('admin.important-links.store') }}" class="space-y-5">
            @csrf
            <div>
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-teal-500 outline-none">{{ old('description') }}</textarea>
            ...
            <div class="flex items-center gap-3 pt-2">
                <button type="submit" class="px-6 py-2 bg-teal-600 text-white text-sm font-semibold rounded-lg hover:bg-teal-700 transition">Add Link</button>
