...
@php
  ...
  $homeSections = [
    ...
    ['events',    8, 'Upcoming Events',       'Upcoming events on the homepage (live from Events module)', true, true],
    ['news',      9, 'Latest News Section',   'Latest news heading (articles from News module)', true, true],
    ['notices',  10, 'Notices & Circulars',   'Latest notices/circulars from the Downloads module', true, true],
    ['links',    11, 'Important Links',       'Useful links from the Important Links module', true, true],
    ['admission',12, 'Admission Section',     'Admission info + inquiry form', true, true],
    ['principal',13, "Principal's Message",   "Principal's photo, quote and message", true, true],
    ['location', 14, 'Location & Contact',    'Map and contact section', true, true],
  ];
  $admissionSections = [
